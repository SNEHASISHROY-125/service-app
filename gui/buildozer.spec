...
# (str) Package name
package.name = localservice

# (str) Package domain (needed for android/ios packaging)
package.domain = org.test.localservice
...
requirements = python3,kivy,datetime, plyer,kivymd==1.2.0,pyjnius, openpyxl, Pillow , et_xmlfile , jdcal, requests
...
android.presplash_lottie = %(source.dir)s/data/food-delivery-bike.json
